...
function reset(){
  ...
  document.querySelector('.state-board').innerHTML = `RESET SUCCESSFUL!!!!`;
...
function controller(user) {
  ...
  document.querySelector('.state-board')
    .innerHTML = `You picked: <img src="/ROCK-PAPER-SCISSORS/image/${user}-emoji.png" class="custom-icon"><br>
    Computer picked: <img src="/ROCK-PAPER-SCISSORS/image/${computerMove}-emoji.png" class="custom-icon"><br>
    Result: ${result}`;
